...
function CaseCard({
  ...
  const currentStyle = {
    ...
    transform: (isAvailable && !isSelected && isHovered) ? 'scale(1.05)' : 'scale(1)',
    borderColor: (isAvailable && !isSelected && (isHovered || isFocused)) ? '#93c5fd' :
                 (isSelected ? '#60a5fa' : 'rgba(255, 255, 255, 0.2)'),
  ...
  return (
    ...
    >
      ...
      <div style={{ ...styles.difficultyBadge, background: difficultyColor }}>
...
function StartButton({ onClick }: { onClick: () => void }) {
  ...
  return (
    <button
      style={{
        ...styles.startButton,
        background: isHovered || isFocused ? '#1d4ed8' : '#2563eb',
      ...
      <div style={styles.wrapper}>
          ...
          {ALL_CASES.map((patientCase) => {
            ...
            return (
              <CaseCard
                ...
                isLocked={isLocked}
                difficultyColor={getDifficultyColor(patientCase.difficulty)}
        ...
        {selectedCase && (
          <div style={styles.detailsBox}>
            ...
            <StartButton onClick={() => onCaseSelected(selectedCase)} />
          </div>
        )}
