...
export function CaseSelector({ onCaseSelected, completedCaseIds }: CaseSelectorProps) {
  ...
  const handleFocus = (e: React.FocusEvent<HTMLButtonElement>, isSelected: boolean) => {
    if (!isSelected) {
  ...
  const handleBlur = (e: React.FocusEvent<HTMLButtonElement>, isSelected: boolean) => {
    if (!isSelected) {
          ...
          {ALL_CASES.map(patientCase => {
            ...
            return (
              <button
                ...
                onFocus={e => isAvailable && handleFocus(e, isSelected)}
                onBlur={e => isAvailable && handleBlur(e, isSelected)}
              >
                {isLocked && (
