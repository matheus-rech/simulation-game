        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div
              style={{
                background: 'rgba(15, 23, 42, 0.9)',
                border: timeRemaining < 300 ? '1px solid #ef4444' : '1px solid #475569',
                borderRadius: '8px',
                padding: '8px 16px',
                minWidth: '120px',
              }}
            >
              ...
              <div style={{ color: timeColor, fontFamily: 'monospace', fontSize: '1.25rem' }}>
      ...
      >
        ...
        >
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <div
              style={{ fontSize: '1.5rem', fontWeight: 700, color: 'white', marginBottom: '8px' }}
            >
              Phase {taskProgress.currentPhase} of{' '}
              {Math.max(...patientCase.objectives.map(o => o.phase))}
            </div>
            {currentObjective && (
          ...
          {currentObjective && (
            ...
            >
              ...
              <div style={{ fontSize: '0.875rem', color: '#d1d5db', marginBottom: '12px' }}>
              ...
              >
                ...
                <div style={{ fontSize: '0.875rem', color: '#6ee7b7', marginTop: '4px' }}>
                  {currentObjective.successCriteria}
                </div>
              </div>
            </div>
          )}
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              {patientCase.criticalStructures.slice(0, 3).map((structure, idx) => (
                <div key={idx} style={{ fontSize: '0.75rem', color: '#fecaca' }}>
                  • {structure}
                </div>
              ))}
            </div>
